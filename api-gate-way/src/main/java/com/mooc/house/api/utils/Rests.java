...
public final class Rests {
  ...
  private static DefaultMsgHandler defaultMsgHandler = new DefaultMsgHandler();
  ...
  public static <T> T exc(Callable<T> callable){
    return exc(callable, defaultMsgHandler);
  }
  
  public static <T> T exc(Callable<T> callable, MsgResultHandler handler){
  ...
  public static class DefaultMsgHandler implements MsgResultHandler {
  ...
  public interface MsgResultHandler {
    <T> T handle(T result);
  }
